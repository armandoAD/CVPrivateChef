	...
	public function display_form( $atts, $content = null ) {
		...
		if ( ! empty( $pirate_forms_options ) ) :
			...
			if ( ! empty( $field ) && ! empty( $label ) ) :
				...
				$wrap_classes = array(
					'col-sm-12 col-lg-4 contact_name_wrap pirate_forms_three_inputs form_field_wrap',
				);
			...
			if ( ! empty( $field ) && ! empty( $label ) ) :
				$required     = $field === 'req' ? true : false;
				$wrap_classes = array(
					'col-sm-12 col-lg-4 contact_email_wrap pirate_forms_three_inputs form_field_wrap',
				);
				// If this field was submitted with invalid data
			...
			if ( ! empty( $field ) && ! empty( $label ) ) :
				$required     = $field === 'req' ? true : false;
				$wrap_classes = array(
					'col-sm-12 col-lg-4 contact_subject_wrap pirate_forms_three_inputs form_field_wrap',
				);
				// If this field was submitted with invalid data
			...
			$elements[] = array(
				...
				'wrap'  => array(
					'type'  => 'div',
					'class' => implode( ' ', apply_filters( 'pirateform_wrap_classes_submit', array( 'col-xs-12 col-sm-12 col-md-4 col-lg-3 form_field_wrap contact_submit_wrap' ) ) ),
				),
