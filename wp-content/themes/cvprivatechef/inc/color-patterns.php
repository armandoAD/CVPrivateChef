<?php
/**
 * CV Private Chef: Color Patterns
 *
 * @package WordPress
 ...
 */
function cvprivatechef_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter CV Private Chef default saturation level.
	 *
	 * @since CV Private Chef 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'cvprivatechef_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.cvprivatechef-front-page) .entry-title,
...
.colors-custom .cvprivatechef-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.cvprivatechef-front-page .panel-content .recent-posts article,
...
.colors-custom.cvprivatechef-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters CV Private Chef custom colors CSS.
	 *
	 * @since CV Private Chef 1.0
	 *
	 ...
	 */
	return apply_filters( 'cvprivatechef_custom_colors_css', $css, $hue, $saturation );
}
