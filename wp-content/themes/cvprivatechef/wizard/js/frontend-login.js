...
$(document).ready(function () {
    ...
    autocompleteFixer = function () {
        ...
        this.checkIt = function () {
            ...
            if ($("#form_users_sign_in_use_email").val() != '') {

                $("#form_users_sign_in_use_email").addClass('valid');
                $("#form_users_sign_in_use_password").addClass('valid');

                $("#form_users_new_user_use_email").addClass('valid');
                $("#form_users_new_user_use_password").addClass('valid');
...
$("#yes-account-check").click(function () {
    $("#yes-account").show();
    $("#no-account").hide();
});

$("#no-account-check").click(function () {
    $("#no-account").show();
    $("#yes-account").hide();
});

if (tab == 'newuser') {
    $("#no-account-check").click();
}
// Notes:
